(function () {
  ...
  const actions = [
    ...
    },
    {
      ...
      label: "Backyard Play",
      category: "training",
      summary: "Loose fun that builds movement early.",
      effects: { athleticism: 2, motivation: 2, family: 1, burnout: -2 }
    },
    {
      id: "playground_games",
      label: "Playground Games",
      category: "training",
      summary: "Unstructured reps against different kids.",
      effects: { skill: 2, confidence: 1, friendship: 2, injuryRisk: 1 }
    },
    {
    ...
    },
    {
      ...
      label: "Sleep Routine",
      category: "training",
      summary: "Better rest, mood, and recovery.",
      effects: { health: 5, burnout: -5, mental: 2, discipline: 1 }
    },
    {
      id: "nutrition_plan",
      label: "Nutrition Plan",
      category: "training",
      summary: "Fuel the body without overthinking it.",
      effects: { health: 5, athleticism: 2, money: -120, discipline: 1 }
    },
    {
      id: "film_study",
      label: "Film Study",
      category: "training",
      summary: "Slow the game down mentally.",
      effects: { skill: 3, coachTrust: 2, discipline: 2, confidence: 1 }
    },
    {
      id: "footwork_drills",
      label: "Footwork Drills",
      category: "training",
      summary: "Balance, movement, and repeatable mechanics.",
      effects: { skill: 2, athleticism: 3, injuryRisk: 1, discipline: 1 }
    },
    {
      id: "clutch_practice",
      label: "Clutch Practice",
      category: "training",
      summary: "Pressure reps for late-game moments.",
      effects: { confidence: 4, skill: 2, pressure: 2, burnout: 1 }
    },
    {
      id: "mobility_work",
      label: "Mobility Work",
      category: "training",
      summary: "Movement quality and injury prevention.",
      effects: { health: 3, injuryRisk: -4, athleticism: 1, burnout: -1 }
    },
    {
      id: "mental_coach",
      label: "Mental Coach",
    ...
    },
    {
      ...
      label: "Talk With Mom",
      category: "relationships",
      summary: "Comfort, honesty, and emotional grounding.",
      effects: { family: 6, mental: 3, burnout: -2, confidence: 1 }
    },
    {
      id: "dad_time",
      label: "Talk With Dad",
      category: "relationships",
      summary: "Expectations, discipline, or a needed reset.",
      effects: { family: 5, discipline: 3, motivation: 2, pressure: 1 }
    },
    {
      id: "sibling_time",
      label: "Sibling Time",
      category: "relationships",
      summary: "Stay human with the people closest to you.",
      effects: { family: 4, friendship: 3, mental: 2, ego: -1 }
    },
    {
      id: "family_dinner",
      label: "Family Dinner",
      category: "relationships",
      summary: "A low-key night that keeps home connected.",
      effects: { family: 5, burnout: -2, motivation: 1, pressure: -1 }
    },
    {
      id: "friend_hangout",
      label: "Friend Hangout",
      category: "relationships",
      summary: "Keep a life outside the grind.",
      effects: { friendship: 8, mental: 4, social: 3, burnout: -2, discipline: -1 }
    },
    {
      id: "school_club",
      label: "School Club",
      category: "relationships",
      summary: "Meet people away from sports pressure.",
      effects: { friendship: 4, academics: 3, mental: 2, burnout: -1 }
    },
    {
      id: "coach_intro",
      label: "Meet Coach",
      category: "relationships",
      summary: "Make the first real connection with staff.",
      effects: { coachTrust: 5, discipline: 2, confidence: 1, pressure: 1 }
    },
    {
      id: "coach_meeting",
      label: "Coach Meeting",
    ...
    {
      id: "teammate_checkin",
      label: "Close Teammate",
      category: "relationships",
      summary: "Build trust with someone in the room.",
      effects: { chemistry: 5, friendship: 4, confidence: 2, ego: -1 }
    },
    {
      id: "rivalry_focus",
      label: "Rivalry Focus",
    ...
    },
    {
      ...
      label: "Local Sponsor",
      category: "business",
      summary: "Small brand money before bigger fame.",
      effects: { money: 450, brand: 3, public: 2, mediaHeat: 1 }
    },
    {
      id: "merch_drop",
      label: "Merch Drop",
      category: "business",
      summary: "Risky personal brand play.",
      effects: { money: 700, brand: 5, social: 4, mediaHeat: 3, burnout: 1 }
    },
    {
      id: "budget_review",
      label: "Budget Review",
      category: "business",
      summary: "Track spending before it gets messy.",
      effects: { financeIQ: 4, wealth: 200, discipline: 1, burnout: 1 }
    },
    {
      id: "nil_push",
      label: "NIL Push",
    ...
    },
    {
      ...
      label: "Training Clip",
      category: "media",
      summary: "Post a clean workout or highlight.",
      effects: { social: 6, brand: 4, confidence: 2, mediaHeat: 2 }
    },
    {
      id: "fan_qna",
      label: "Fan Q&A",
      category: "media",
      summary: "Talk directly with supporters.",
      effects: { social: 5, public: 4, mental: 1, burnout: 1, ego: 1 }
    },
    {
      id: "apology_statement",
      label: "Calm the Timeline",
      category: "media",
      summary: "Lower heat when the noise gets loud.",
      effects: { mediaHeat: -8, public: 2, discipline: 2, social: -2, mental: -1 }
    },
    {
      id: "charity_event",
      label: "Charity Event",
    ...
    },
    {
      ...
      label: "Podcast Clip",
      category: "media",
      summary: "Tell a longer story and risk a quote getting clipped.",
      effects: { social: 4, public: 3, brand: 3, mediaHeat: 2 }
    },
    {
      id: "behind_scenes",
      label: "Behind Scenes",
      category: "media",
      summary: "Show the work without making it too polished.",
      effects: { social: 5, brand: 3, public: 2, ego: 1 }
    },
    {
      id: "media_blackout",
  ...
  const actionRules = {
    ...
    backyard_play: { minAge: 1, maxAge: 10 },
    playground_games: { minAge: 5, maxAge: 13 },
    balanced_training: { minAge: 7 },
    skill_lab: { minAge: 8 },
    strength_speed: { minAge: 12 },
    recovery_block: { minAge: 5 },
    sleep_routine: { minAge: 0 },
    nutrition_plan: { minAge: 8 },
    film_study: { minAge: 10 },
    footwork_drills: { minAge: 7 },
    clutch_practice: { minAge: 12 },
    mobility_work: { minAge: 7 },
    mental_coach: { minAge: 12 },
    offseason_camp: { minAge: 13 },
    family_time: { minAge: 0 },
    mom_time: { minAge: 0 },
    dad_time: { minAge: 0 },
    sibling_time: { minAge: 2 },
    family_dinner: { minAge: 0 },
    friend_hangout: { minAge: 5 },
    school_club: { minAge: 6 },
    coach_intro: { minAge: 8 },
    coach_meeting: { minAge: 8 },
    mentor_session: { minAge: 10 },
    team_bonding: { minAge: 10 },
    teammate_checkin: { minAge: 10 },
    rivalry_focus: { minAge: 12 },
    agent_meeting: { minAge: 15 },
    local_sponsor: { minAge: 13 },
    merch_drop: { minAge: 15 },
    budget_review: { minAge: 12 },
    nil_push: { minAge: 15 },
    smart_investment: { minAge: 16 },
    lifestyle_splurge: { minAge: 13 },
    press_work: { minAge: 13 },
    social_posting: { minAge: 12 },
    training_clip: { minAge: 12 },
    fan_qna: { minAge: 13 },
    apology_statement: { minAge: 13 },
    charity_event: { minAge: 12 },
    podcast_clip: { minAge: 15 },
    behind_scenes: { minAge: 12 },
  ...
  function buildProceduralEvents() {
    const merge = (...items) =>
    ...
    const domains = [
      { id: "training", title: "Training", minAge: 7, bold: { skill: 3, burnout: 2 }, steady: { discipline: 2, health: 1 }, safe: { burnout: -2, injuryRisk: -1 } },
      { id: "school", title: "School", minAge: 6, maxAge: 20, bold: { academics: 3, discipline: 1 }, steady: { mental: 2, academics: 2 }, safe: { burnout: -1, family: 1 } },
      { id: "family", title: "Home", minAge: 5, bold: { motivation: 2, family: -2 }, steady: { family: 3, mental: 1 }, safe: { burnout: -2, discipline: 1 } },
      { id: "friends", title: "Friends", minAge: 5, bold: { social: 3, discipline: -1 }, steady: { friendship: 3, mental: 1 }, safe: { burnout: -1, social: 1 } },
      { id: "coach", title: "Coach", minAge: 8, bold: { coachTrust: 3, confidence: 1 }, steady: { discipline: 2, coachTrust: 2 }, safe: { ego: -1, mental: 1 } },
      { id: "team", title: "Team", minAge: 10, bold: { chemistry: 3, confidence: 1 }, steady: { chemistry: 2, friendship: 2 }, safe: { burnout: -1, coachTrust: 1 } },
      { id: "rival", title: "Rivalry", minAge: 12, bold: { rivalry: 4, confidence: 2, ego: 1 }, steady: { motivation: 3, discipline: 1 }, safe: { mental: 2, mediaHeat: -1 } },
      { id: "media", title: "Media", minAge: 12, bold: { social: 3, brand: 2, mediaHeat: 2 }, steady: { public: 2, brand: 2 }, safe: { mediaHeat: -3, discipline: 1 } },
      { id: "money", title: "Money", minAge: 14, bold: { money: 500, financeIQ: -1 }, steady: { financeIQ: 3, wealth: 250 }, safe: { money: -150, financeIQ: 2 } },
      { id: "health", title: "Body", minAge: 7, bold: { athleticism: 3, injuryRisk: 2 }, steady: { health: 2, discipline: 1 }, safe: { health: 4, injuryRisk: -3 } }
    ];
    const scenes = [
      "a late ride home",
      "a messy group chat",
    ...
    const twists = [
      { id: "pressure", text: "The pressure rises before anyone says it out loud.", effects: { pressure: 2, burnout: 1 } },
      { id: "hype", text: "People start treating this moment like it matters.", effects: { public: 1, confidence: 1, mediaHeat: 1 } },
      { id: "doubt", text: "A little doubt creeps in and asks for a response.", effects: { confidence: -1, mental: -1 } },
      { id: "support", text: "Someone unexpected gives real support.", effects: { mental: 2, motivation: 1 } },
      { id: "money", text: "A small money choice sits under the bigger dream.", effects: { financeIQ: 1, money: -80 } },
      { id: "noise", text: "The outside noise gets louder than the work.", effects: { mediaHeat: 2, burnout: 1 } }
    ];
    const choices = [
      { label: "Lean In", effects: { confidence: 1, motivation: 1 }, log: "You lean into the moment and accept the risk." },
      { label: "Stay Balanced", effects: { discipline: 1, mental: 1 }, log: "You keep the response balanced and useful." },
      { label: "Protect Energy", effects: { burnout: -2, health: 1 }, log: "You protect energy and let the moment breathe." }
    ];
    const events = [];
    domains.forEach((domain) => {
      scenes.forEach((scene, sceneIndex) => {
        twists.forEach((twist, twistIndex) => {
          const baseId = `life_${domain.id}_${sceneIndex}_${twist.id}_${twistIndex}`;
          events.push({
            id: baseId,
            title: `${domain.title}: ${scene}`,
            text: twist.text,
            ...
            choices: choices.map((choice, choiceIndex) => ({
              label: choice.label,
              effects: merge(choiceIndex === 0 ? domain.bold : choiceIndex === 1 ? domain.steady : domain.safe, twist.effects, choice.effects),
              log: choice.log
            }))
          });
        });
  ...
  majorEvents.push(...buildProceduralEvents());
