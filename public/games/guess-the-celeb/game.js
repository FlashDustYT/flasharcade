...
const CELEBRITIES = [
  ...
  {
    name: "Emma Watson",
    aliases: ["hermione", "watson"],
    category: "Movies",
    facts: [
      "British actor who played Hermione Granger.",
      "Grew up on screen in the Harry Potter films.",
      "Played Belle in Disney's live-action Beauty and the Beast.",
      "Studied at Brown University while maintaining an acting career.",
      "Has been active in gender equality advocacy.",
      "Starred in The Perks of Being a Wallflower.",
      "Known for balancing blockbuster fame with activism.",
      "Her most famous character is brilliant, bookish, and magical."
    ]
  },
  {
    name: "Johnny Depp",
    aliases: ["depp", "jack sparrow"],
    category: "Movies",
    facts: [
      "Actor known for playing Captain Jack Sparrow.",
      "Frequently collaborated with Tim Burton.",
      "Starred in Edward Scissorhands and Pirates of the Caribbean.",
      "Often plays eccentric characters with unusual voices or costumes.",
      "Played Willy Wonka in Charlie and the Chocolate Factory.",
      "Started on the TV series 21 Jump Street.",
      "Has also performed as a musician.",
      "One signature role involves eyeliner, beads, and a pirate hat."
    ]
  },
  {
    name: "Chris Evans",
    aliases: ["captain america", "evans"],
    category: "Movies",
    facts: [
      "Actor best known for playing Captain America.",
      "Carried a shield across many Marvel movies.",
      "Starred in Knives Out as Ransom Drysdale.",
      "Played Johnny Storm before becoming Steve Rogers.",
      "Known for clean-cut superhero charm and comic timing.",
      "Appeared in Snowpiercer and The Gray Man.",
      "Often associated with the phrase Avengers assemble.",
      "His Marvel character wakes up in a world far past his own era."
    ]
  },
  {
    name: "Gal Gadot",
    aliases: ["wonder woman", "gadot"],
    category: "Movies",
    facts: [
      "Actor who played Wonder Woman in DC films.",
      "Born in Israel and competed in pageants before acting.",
      "Appeared in Fast & Furious films.",
      "Known for action roles and a warrior-princess image.",
      "Served in the Israeli military before her Hollywood career.",
      "Starred in Red Notice and Death on the Nile.",
      "Her signature superhero uses a lasso and bracelets.",
      "Became a global star with a 2017 superhero film."
    ]
  },
  {
    name: "Millie Bobby Brown",
    aliases: ["millie", "eleven"],
    category: "Movies",
    facts: [
      "Actor who became famous as Eleven on Stranger Things.",
      "Played Enola Holmes in Netflix mystery films.",
      "Known for a shaved-head breakout role and supernatural powers.",
      "Started acting while still very young.",
      "Appeared in Godzilla films.",
      "Founded a beauty brand called Florence by Mills.",
      "Her most famous character loves waffles.",
      "Became one of Netflix's biggest young stars."
    ]
  },
  {
    name: "Pedro Pascal",
    aliases: ["pascal", "mando", "the mandalorian"],
    category: "Movies",
    facts: [
      "Actor known for The Mandalorian and The Last of Us.",
      "Played Oberyn Martell on Game of Thrones.",
      "Often plays protective, reluctant father-figure roles.",
      "Born in Chile and raised partly in the United States.",
      "His Star Wars character often says this is the way.",
      "Played Joel in a video-game adaptation for HBO.",
      "Appeared in Narcos and Wonder Woman 1984.",
      "Became a major internet favorite in the 2020s."
    ]
  },
  {
    name: "Jenna Ortega",
    aliases: ["jenna", "wednesday"],
    category: "Movies",
    facts: [
      "Actor who played Wednesday Addams in a Netflix series.",
      "Known for deadpan delivery and gothic style.",
      "Appeared in Scream films.",
      "Started acting on Disney Channel.",
      "Performed a viral dance scene as Wednesday.",
      "Starred in the horror film X.",
      "Often works in horror and dark comedy.",
      "Her breakout character attends Nevermore Academy."
    ]
  },
  {
    name: "Ice Spice",
    ...
    category: "Music",
    facts: [
      "Bronx rapper with a signature orange curly hairstyle.",
      "Broke through with viral drill-influenced songs.",
      "Recorded the song Munch.",
      "Collaborated with Nicki Minaj and Taylor Swift.",
      "Known for calm delivery over bouncy beats.",
      "Her stage name combines cold imagery with heat.",
      "Became a major TikTok-era rap name.",
      "Often uses short hooks that turn into memes."
    ]
  },
  {
    name: "Post Malone",
    aliases: ["posty", "austin post"],
    category: "Music",
    facts: [
      "Singer and rapper whose real name is Austin Post.",
      "Broke through with White Iverson.",
      "Known for face tattoos and genre-blending hits.",
      "Released songs including Circles, Rockstar, and Sunflower.",
      "Often mixes hip-hop, pop, rock, and country influences.",
      "Collaborated on Sunflower for Spider-Man: Into the Spider-Verse.",
      "Has a laid-back public persona and love of guitars.",
      "Fans often call him Posty."
    ]
  },
  {
    name: "Travis Scott",
    aliases: ["trav", "la flame"],
    category: "Music",
    facts: [
      "Houston rapper and producer associated with Astroworld.",
      "Known for psychedelic trap production and Auto-Tuned vocals.",
      "Released hits including Sicko Mode and Goosebumps.",
      "Has a fan base tied to the phrase rage.",
      "Collaborated with brands including Nike and McDonald's.",
      "Has children with Kylie Jenner.",
      "His stage shows often use amusement-park imagery.",
      "Often uses the nickname La Flame."
    ]
  },
  {
    name: "Tyler The Creator",
    aliases: ["tyler", "tyler okonma"],
    category: "Music",
    facts: [
      "Rapper, producer, and designer who came from Odd Future.",
      "Released albums including Flower Boy, Igor, and Call Me If You Get Lost.",
      "Known for colorful visuals, alter egos, and self-produced music.",
      "Founded the Camp Flog Gnaw festival.",
      "Has a fashion brand called Golf Wang.",
      "Won Grammys for rap albums.",
      "Often directs his own videos under a pseudonym.",
      "His music moved from shock rap into lush, melodic production."
    ]
  },
  {
    name: "Lizzo",
    aliases: ["melissa jefferson"],
    category: "Music",
    facts: [
      "Singer, rapper, and flutist known for body-positive anthems.",
      "Released hits including Truth Hurts, Juice, and About Damn Time.",
      "Often plays a flute named Sasha Flute.",
      "Known for energetic performances and big vocals.",
      "Her real name is Melissa Jefferson.",
      "Won Grammys for pop and R&B-adjacent music.",
      "Started in music scenes in Minneapolis and Houston.",
      "Her songs often blend confidence, humor, and dance grooves."
    ]
  },
  {
    name: "J Balvin",
    ...
    category: "Music",
    facts: [
      "Colombian reggaeton star from Medellin.",
      "Released hits including Mi Gente and Ginza.",
      "Known for colorful hair, fashion, and global collaborations.",
      "Helped bring Spanish-language urban music to worldwide audiences.",
      "Collaborated with Beyonce on a remix of Mi Gente.",
      "Often calls himself the prince of reggaeton.",
      "Has worked with artists across Latin pop and hip-hop.",
      "His music helped define the global reggaeton wave."
    ]
  },
  {
    name: "Karol G",
    aliases: ["karol", "bichota"],
    category: "Music",
    facts: [
      "Colombian singer known for reggaeton and Latin pop.",
      "Released hits including Tusa, Bichota, and Provenza.",
      "Often uses blue or bright-colored hair in major eras.",
      "Became one of the biggest women in Latin music.",
      "Won major awards for Spanish-language albums.",
      "Her nickname Bichota became a confidence anthem.",
      "Has collaborated with Nicki Minaj and Shakira.",
      "Known for arena shows with strong fan sing-alongs."
    ]
  },
  {
    name: "PewDiePie",
    aliases: ["felix kjellberg", "pewdiepie"],
    category: "Creators",
    facts: [
      "Swedish YouTube creator whose real name is Felix Kjellberg.",
      "Became famous through gaming videos and Let's Plays.",
      "Was once the most-subscribed individual creator on YouTube.",
      "Known for a long-running online rivalry with T-Series.",
      "His early fame was tied to horror-game reactions.",
      "Built a fan base often called the Bro Army.",
      "Later shifted into commentary and lifestyle content.",
      "His channel name is one of YouTube's most recognizable."
    ]
  },
  {
    name: "KSI",
    ...
    category: "Creators",
    facts: [
      "British YouTuber, boxer, rapper, and entrepreneur.",
      "Member of the Sidemen.",
      "His real name is JJ Olatunji.",
      "Fought Logan Paul in high-profile boxing matches.",
      "Co-founded the drink brand Prime with Logan Paul.",
      "Started with FIFA gaming videos.",
      "Released music that charted in the UK.",
      "Built a career across online video, sports events, and music."
    ]
  },
  {
    name: "Logan Paul",
    ...
    category: "Creators",
    facts: [
      "Creator, boxer, and WWE performer who first rose on Vine.",
      "Co-founded Prime with KSI.",
      "Fought Floyd Mayweather in an exhibition boxing match.",
      "Hosts the podcast Impaulsive.",
      "Has a brother named Jake Paul.",
      "Transitioned from daily vlogging into combat sports and wrestling.",
      "Known for loud marketing and internet controversy.",
      "Became a United States Champion in WWE."
    ]
  },
  {
    name: "Kai Cenat",
    ...
    category: "Creators",
    facts: [
      "Streamer known for energetic live broadcasts.",
      "Became one of Twitch's biggest personalities.",
      "Part of the creator group AMP.",
      "Known for celebrity guests, comedy, and loud reactions.",
      "Won major streamer awards.",
      "Built a huge audience from New York-based content.",
      "Often turns live moments into viral clips.",
      "His streams mix gaming, challenges, and guest appearances."
    ]
  },
  {
    name: "Greta Thunberg",
    ...
    category: "Icons",
    facts: [
      "Swedish climate activist who began school strikes for climate.",
      "Known for direct speeches to world leaders.",
      "Started the Fridays for Future movement.",
      "Sailed across the Atlantic to avoid flying for a climate summit.",
      "Her phrase how dare you became widely quoted.",
      "Became internationally known as a teenager.",
      "Focuses attention on climate science and emissions.",
      "Often uses blunt, concise public statements."
    ]
  },
  {
    ...
    category: "Icons",
    facts: [
      "Pakistani activist known for girls' education advocacy.",
      "Became the youngest Nobel Peace Prize laureate.",
      "Survived an attack by the Taliban as a teenager.",
      "Wrote the memoir I Am Malala.",
      "Studied at Oxford University.",
      "Founded the Malala Fund.",
      "Often speaks about education as a human right.",
      "Her first name alone is globally recognizable."
    ]
  },
  {
    ...
    category: "Icons",
    facts: [
      "Theoretical physicist known for work on black holes.",
      "Wrote the bestseller A Brief History of Time.",
      "Used a speech-generating device for much of his public life.",
      "Held a famous academic post at Cambridge.",
      "Studied cosmology and the nature of the universe.",
      "Lived for decades with ALS.",
      "Appeared in pop culture shows including The Simpsons.",
      "His work made complex physics part of mainstream conversation."
    ]
  },
  {
    name: "Neil deGrasse Tyson",
    aliases: ["neil degrasse tyson", "tyson"],
    category: "Icons",
    facts: [
      "Astrophysicist and science communicator.",
      "Hosted a modern version of Cosmos.",
      "Directed the Hayden Planetarium in New York.",
      "Known for explaining space science in media appearances.",
      "Frequently discusses planets, stars, and the universe.",
      "His last name is shared with a famous boxer, but he studies space.",
      "Has written popular science books.",
      "Often appears in interviews about astronomy and physics."
    ]
  },
  {
    name: "Martha Stewart",
    ...
    category: "Icons",
    facts: [
      "Lifestyle entrepreneur known for cooking, decorating, and home advice.",
      "Built a media brand around domestic skills.",
      "Hosted television shows and published magazines.",
      "Has an unlikely famous friendship with Snoop Dogg.",
      "Known for polished entertaining and home design.",
      "Released cookbooks and home product lines.",
      "Her name became shorthand for perfect homemaking.",
      "Appeared on cooking shows with celebrity guests."
    ]
  },
  {
    name: "Guy Fieri",
    ...
    category: "Icons",
    facts: [
      "Celebrity chef known for spiky blond hair and flame shirts.",
      "Hosts Diners, Drive-Ins and Dives.",
      "Often says food is headed to Flavortown.",
      "Known for bold comfort food and road-trip restaurants.",
      "Won a season of The Next Food Network Star.",
      "Has a recognizable sunglasses-on-backwards look.",
      "Frequently features burgers, barbecue, and fried food.",
      "Turned casual restaurant visits into a TV empire."
    ]
  },
  {
    name: "Caitlin Clark",
    ...
    category: "Sports",
    facts: [
      "Basketball guard known for deep three-point shooting.",
      "Became a college superstar at Iowa.",
      "Set major NCAA scoring records.",
      "Entered the WNBA with enormous attention.",
      "Known for logo-range shots and sharp passing.",
      "Helped bring record viewership to women's basketball.",
      "Played for the Indiana Fever as a pro.",
      "Often draws comparisons to long-range NBA shooters."
    ]
  },
  {
    name: "Neymar",
    ...
    category: "Sports",
    facts: [
      "Brazilian football star known for flair and dribbling.",
      "Played for Barcelona, Paris Saint-Germain, and Brazil.",
      "Formed a famous attacking trio with Messi and Suarez.",
      "Known for tricks, stepovers, and creative attacking play.",
      "Won Olympic gold with Brazil.",
      "Started his senior career at Santos.",
      "Often wears the number 10 for Brazil.",
      "One of the most famous Brazilian players of his generation."
    ]
  },
  {
    name: "Shaquille O'Neal",
    aliases: ["shaquille oneal", "shaquille", "shaq"],
    category: "Sports",
    facts: [
      "NBA legend commonly known as Shaq.",
      "Won championships with the Los Angeles Lakers and Miami Heat.",
      "Known for dominant size, dunks, and backboard-shaking power.",
      "Became a TV analyst after basketball.",
      "Released rap music and appeared in movies.",
      "Played college basketball at LSU.",
      "Was part of a famous duo with Kobe Bryant.",
      "His free throws were a famous weakness despite his dominance."
    ]
  },
  {
    name: "Venus Williams",
    ...
    category: "Sports",
    facts: [
      "Tennis champion and older sister of Serena Williams.",
      "Won multiple Wimbledon singles titles.",
      "Helped fight for equal prize money in tennis.",
      "Known for powerful serves and athletic court coverage.",
      "Started training in Compton with her family.",
      "Has Olympic gold medals in singles and doubles.",
      "Built fashion and design businesses outside tennis.",
      "Her family story helped inspire the film King Richard."
    ]
  },
  {
    name: "Conor McGregor",
    ...
    category: "Sports",
    facts: [
      "Irish mixed martial artist known for trash talk and knockouts.",
      "Became a UFC champion in two weight classes.",
      "Fought Floyd Mayweather in a boxing match.",
      "Known for sharp suits, bold predictions, and a left hand.",
      "Popularized the phrase the Notorious as a personal brand.",
      "Helped make UFC events major pay-per-view spectacles.",
      "Had famous rivalries with Jose Aldo and Khabib Nurmagomedov.",
      "Carries an Irish flag image into fight promotion."
    ]
  },
  {
    name: "Lewis Hamilton",
    ...
    category: "Sports",
    facts: [
      "Formula 1 driver with multiple world championships.",
      "Drove for Mercedes during a dominant era.",
      "Known for speed, fashion, and activism.",
      "Began racing in karting as a child in Britain.",
      "Tied or broke many major Formula 1 records.",
      "Uses the number 44 on his car.",
      "Has been a leading voice for diversity in motorsport.",
      "Often battles at high speed on famous circuits around the world."
    ]
  }
];
...
function getDifficulty(round) {
  const level = Math.min(7, Math.floor((round - 1) / 5) + 1);
...
function questionKey(celebrity, hints) {
  return `${celebrity.name}|${hints.slice().sort().join("~")}`;
}

function buildQuestion() {
  let available = CELEBRITIES.filter((celebrity) => !state.usedCelebrities.has(celebrity.name));
  if (available.length === 0) {
    state.usedCelebrities.clear();
    available = [...CELEBRITIES];
    setFeedback("Full tour completed. The celebrity pool has refreshed.");
  }

  for (let attempt = 0; attempt < 80; attempt += 1) {
    const celebrity = choose(available);
    const hints = sample(celebrity.facts, 3);
    const key = questionKey(celebrity, hints);
    if (!state.usedQuestionKeys.has(key)) {
      state.usedCelebrities.add(celebrity.name);
      state.usedQuestionKeys.add(key);
      return { celebrity, hints, key };
    }
  }
...
function nextRound(message = "New celebrity. Read the clues.") {
  ...
  state.current = question.celebrity;
  state.currentHints = question.hints;
  state.currentQuestionKey = question.key;
  state.revealedHints = state.hardMode ? 1 : state.currentHints.length;
  renderRound();
  setFeedback(message);
  startTimer();
...
function renderHints() {
  ...
  state.currentHints.forEach((hint, index) => {
    ...
    card.className = isVisible ? "hint-card" : "hint-card locked";
...
function renderHintTools() {
  ...
  const penalty = state.hardMode ? Math.max(0, (state.revealedHints - 1) * HINT_REVEAL_PENALTY) : 0;
  ...
  dom.clueValueText.textContent =
    state.hardMode && penalty > 0 ? `${penalty} point clue penalty` : state.hardMode ? "Hard clue mode" : "Normal: all clues open";
}

function revealHint() {
  if (!state.hardMode) {
    setFeedback("Normal mode keeps all clues and options open. Turn on Hard Mode for clue reveals.");
    playSound("wrong");
    return;
  }
  ...
  renderHints();
  renderChoices();
  setFeedback(`Hint ${state.revealedHints} revealed. Correct answers are worth ${HINT_REVEAL_PENALTY} fewer points now.`);
}
...
function renderChoices() {
  ...
  if (choicesLocked) {
    ...
    locked.textContent = "Reveal clue 2 to unlock the answer choices.";
...
function handleCorrect() {
  ...
  const revealPenalty = state.hardMode ? Math.max(0, (state.revealedHints - 1) * HINT_REVEAL_PENALTY) : 0;
  const difficultyBonus = (state.difficulty.level - 1) * 25 + (state.hardMode ? 40 : 0);
  const points = Math.max(25, 120 + timeBonus + streakBonus + difficultyBonus - revealPenalty);
  state.score += points;
  state.streak += 1;
  state.correct += 1;
...
function newGame(seed = Date.now(), mode = state.mode) {
  ...
  state.usedCelebrities.clear();
  state.usedQuestionKeys.clear();
  state.revealedHints = state.hardMode ? 1 : 3;
  clearInterval(state.timerId);
  renderStats();
...
function musicPulse() {
  ...
  const melody = [392, 494, 587, 740, 659, 587, 494, 440];
  const bass = [98, 98, 123.47, 146.83];
  const step = state.musicStep;
  const tempoBoost = Math.min(36, (state.difficulty.level - 1) * 4);
  playMusicTone(melody[step % melody.length], 0.16, "triangle", 0.075);
  if (step % 2 === 0) {
    playMusicTone(melody[(step + 2) % melody.length] * 2, 0.06, "sine", 0.035, 0.03);
  }
  if (step % 4 === 0) {
    playMusicTone(bass[Math.floor(step / 4) % bass.length], 0.24, "sawtooth", 0.055);
  }
  state.musicStep += 1;

  clearTimeout(state.musicTimerId);
  state.musicTimerId = setTimeout(musicPulse, Math.max(170, 260 - tempoBoost));
}
...
function startMusic() {
  ...
  playMusicTone(587, 0.12, "sine", 0.08, 0.04);
  playMusicTone(740, 0.16, "triangle", 0.1, 0.08);
  musicPulse();
}
...
dom.hardModeButton.addEventListener("click", () => {
  ...
  playSound("tap");
  newGame(Date.now(), state.mode);
  setFeedback(state.hardMode ? "Hard Mode on. Clues and choices are locked until you reveal them." : "Normal Mode on. Clues and choices are open for easier tapping.");
});
